...
import spittr.spring.mvc.web.SpittleController;
...
public class SpittleControllerTest {
    ...
    public void shouldShowRecentSpittles() throws Exception{
        ...
        MockMvc mockMvc = standaloneSetup(controller).setSingleView(new InternalResourceView("/WEB-INF/jsp/view/spittles.jsp")).build();
    ...
    public void shouldShowPagedSpittles() throws Exception{
        ...
        mockMvc.perform(get("/spittles?max=238900&count=50")).andExpect(view().name("spittles"))
                .andExpect(model().attributeExists("spittleList")).andExpect(model().attribute("spittleList", hasItems(expectedSpittles.toArray())));
    }
